...
object Target:
  sealed class LinuxX64 private[Target] extends Target { val id: Int = 1; val realId: Int = id }
  sealed class WinX64 private[Target] extends Target { val id: Int = 2; val realId: Int = id}
  sealed class MacX64 private[Target] extends Target { val id: Int = 3; val realId: Int = id}
